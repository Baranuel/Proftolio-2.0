...
function Tools() {
  return (
    <div className="min-h-screen w-screen justify-between xl:justify-center items-center flex lg:flex-col-reverse px-48 2xl:px-24 xl:px-12 lg:px-12 sm:px-4 py-24 gap-8">
