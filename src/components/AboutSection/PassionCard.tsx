...
function PassionCard({
  ...
  return (
    <div className=" flex items-center justify-center relative min-h-[400px] max-h-[5] h-full max-w-[500px] w-2/5  lg:w-3/5 md:w-4/5 sm:w-full  rounded-lg z-50 bg-white border border-1 border-purple-200">
