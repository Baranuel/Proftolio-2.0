  ...
  return (
    <html style={{ overflowX: "hidden", scrollBehavior: "smooth" }} lang="en">
      <body className="flex flex-col justify-between min-h-screen">
        <main>{children}</main>
        <footer className=" min-h-[10vh] md:text-sm text-md  flex md:flex-col justify-between items-center w-screen bg-white px-48 2xl:px-24 xl:px-12 lg:px-12 sm:px-6 py-4">
          <p>
